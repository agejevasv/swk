...
// DifferError signals that two compared inputs differ (exit code 1, like diff).
// The diff itself is already on stdout; no stderr diagnostic is needed.
type DifferError struct{}

func (DifferError) Error() string { return "" }
func (DifferError) ExitCode() int { return 1 }
